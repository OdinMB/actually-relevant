...
| Carousel PNG and PDF | own | own unsigned XMP and PDF Info | `exiftool -a -G1` | 2026-09-25 | `xmp.test.ts` (chunk order, CRC, decode), `carousel.test.ts`; sample files inspected (pdftk `dump_data`, XMP packet in the PNG) | pass |
